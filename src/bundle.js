var net = require('net');
var fs = require('fs');
var path = require('path'), temp = require('temp'), colony = require('colony'), async = require('async'), fstream = require('fstream'), tar = require('tar'), osenv = require('osenv'), effess = require('effess');
(function () {
