...
var DFU_DETACH = 0;
// OUT        wTimeout    Interface   Zero        None
var DFU_DNLOAD = 1;
// OUT        wBlockNum   Interface   Length      Firmware
var DFU_UPLOAD = 2;
// IN         Zero        Interface   Length      Firmware
var DFU_GETSTATUS = 3;
// IN         Zero        Interface   6           Status
var DFU_CLRSTATUS = 4;
// OUT        Zero        Interface   Zero        None
var DFU_GETSTATE = 5;
// IN         Zero        Interface   1           State
var DFU_ABORT = 6;
// OUT        Zero        Interface   Zero        None
// bmRequestType flags
var TYPE_IN = 161;
...
function DFU(device, altsetting) {
  ...
  for (var i = 0; i < this.device.interfaces.length; i++) {
    ...
    if (descriptor.bInterfaceClass == 254 && descriptor.bInterfaceSubClass == 1) {
      found = true;
      this.bInterface = descriptor.bInterfaceNumber;
      this.iface = this.device.interfaces[i];
      if (descriptor.extra[1] != 33) {
